...
//click donateToTarget //donateすることでHackしたいcontractにAccessできるようになる
...
/D-squared youtube channelも参考にする！ //https://www.youtube.com/watch?v=VLueCEEAuIQ

*Flaw
Check > Interact > Effect(wrong order) - leads to re-entrancy flaw 
Externally owned account (EOA)... *Assumption => Baked in assumption that we are going to interact with an EOA. but in the real-world contracts a fair game too. 
